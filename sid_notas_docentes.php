...
<html>
	...
	<p align = "middle">  <h1>Resultado da Pesquisa - Notas Docentes</h1> </p>
    <p align = "middle"> <input type="button" onClick="document.location='sid_login_fatec.php'" value="&nbsp &nbsp Sair &nbsp &nbsp "><br />
    <br>
	<p align = "middle"> <input type="button" onClick="document.location='sid_grafico_docentes_teste.php?cod_prof=<?php echo $_GET["cod_prof"];?> '" value="&nbsp &nbsp Graficos &nbsp &nbsp "><br />

...
<p align = "middle"> <input type="button" onClick="document.location='sid_modulo_docentes.php'" value="  Retornar ao Menu  "><br />
	<form method="post" action="sid_aluno_modulo_docente.php">	
    <br>
...
<!--	<p align = "middle"> <input type="button" onClick="document.location='sid_importador_fatec_csv.php'" value="  Importar novo Arquivo  "><br />
	<form method="post" action="sid_importador_fatec_csv.php">	-->
	 <br>
	 <p align = "middle"> <input type="button" onClick="document.location='sid_cadastro_aluno_mod_docente.php'" value="Cadastrar Novo Aluno" name="Cadastrar ">	
	 <br>
	 <br>
...
{ 	 /*Transf.linha da tabela em link -> <a href='detalhe_aluno.php?aluno=" . $escrever['matr_aluno'] . */							 
	print " <tr><td> ". $escrever['nome_aluno'] ." </td>
			<td><a href= 'sid_grafico_aluno_mod_docente.php?aluno=". $escrever['nome_aluno'] .

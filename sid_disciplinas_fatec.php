...
<p align = "middle">  <h1>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Resultado da Pesquisa - Disciplinas</h1> </p>



<p align = "middle"> <input type="button" onClick="document.location='sid_admin_fatec.php'" value="  Retornar ao Menu  "><br />
	...
	<br>
	<br>
	 <p align = "middle"> <input type="button" onClick="document.location='sid_cadastro_disciplinas.php'" value="Cadastrar Nova Disciplina" name="Cadastrar ">	
	 <br><br>
...
{ 	 /*Transf.linha da tabela em link -> <a href='detalhe_aluno.php?discip=" . $escrever['cod_discip'] . */		
	...
	print " <tr><td> ". $escrever['cod_discip'] ." </td>
			<td><a href= 'sid_disciplinas.php?discip=". $escrever['nome_discip'] .
				"&cod_discip=". $escrever['cod_discip'] ."&nome_discip=". $escrever['nome_discip'] .
				"&nome_prof=". $escrever['nome_prof'] ."' >  " . $escrever['nome_discip'] . " </a></td>

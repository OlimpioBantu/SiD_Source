...
?>
	...
	<h3 align="middle">			e-mail Aluno :
					<input type="text" name="email_aluno" value="<?php echo $email_aluno; ?>">
	<h3 align="middle">			Nome da Mae :
...
<br> <br>
<input type="button" onClick="document.location='sid_modulo_docentes.php'" value="  Retornar ao Menu " ><br />	
<br />   <br>				
	</form>
</body>
</html>
...
<?php
	...
	header('Content-Type: text/html; charset=UTF-8');
		$import ="SELECT  matr_aluno, nome_aluno, email_aluno, ano_ingresso, nome_mae FROM alunos";
...
{
 echo "<h1>" . "Arquivo: ". $_FILES['filename']['name'] .", carregado com sucesso ! ." . "</h1>";
			echo "<h2>Exibindo os Dados:</h2>";  // arquivo tranferido
				readfile($_FILES['filename']['tmp_name']);
}
$handle = fopen($_FILES['filename']['tmp_name'], "r"); 
 /*Importa o arquivo transferido para o banco de dados, abrir arquivos com r você vai 
 lê-lo com w ou w+, pode-se alterar e caso queira ler e depois alterar só usar as duas rw ou rw+. */ 
	   while (($line = fgetcsv($handle,0,";")) !==false)
	{
	 $sql="INSERT INTO fatec.alunos (matr_aluno, nome_aluno, email_aluno, ano_ingresso, nome_mae) VALUES('".$line[0]."', '".$line[1]."', '".$line[2]."', '".$line[3]."', '".$line[4]."')";// carrega na tela os dados
